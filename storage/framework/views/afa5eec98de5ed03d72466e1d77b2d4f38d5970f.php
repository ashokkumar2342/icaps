...
<head>
    ...
    <title><?php echo e(env('app.name','I-CAPS')); ?> :: Admin Panel</title>

    <!--switchery-->
    <link href="<?php echo e(asset('js/switchery/switchery.min.css')); ?>" rel="stylesheet" type="text/css" media="screen" />
    <link href="<?php echo e(mix('css/admin.css')); ?>" rel="stylesheet" type="text/css" />
     <!--Data Table-->
...
<?php  $sn=0;  ?>
 <section >
   <?php echo $__env->make('admin.include.left-sidebar', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
    <!-- body content start-->
