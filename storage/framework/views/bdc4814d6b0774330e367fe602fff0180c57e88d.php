    ...
    <div class="wrapper">
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                <?php echo e(Form::open(['route'=>['admin.member.request.update', $user->id],'method'=>'put'])); ?>
                                ...
                                <div class="col-md-12">
                                    <div class="col-lg-3">
                                        <div class="radio-custom radio-primary">
                                            <input type="radio" <?php echo e((old('member_type') == 0)?'checked':''); ?> value="0"   name="member_type" id="default">
                                            <label for="default">Free</label>
                                        </div>
                                    </div>
                                    <div class="col-lg-3">
                                        <div class="radio-custom radio-danger">
                                            <input type="radio" <?php echo e((old('member_type') == 1)?'checked':''); ?> value="1"   name="member_type" id="danger">
                                            <label for="danger">Red</label>
                                        </div>
                                    </div>
                                    <div class="col-lg-3">
                                        <div class="radio-custom radio-success">
                                            <input type="radio" <?php echo e((old('member_type') == 2)?'checked':''); ?> value="2"   name="member_type" id="success">
                                            <label for="success">Green</label>
                                        </div>
                                    </div>
                                    <div class="col-lg-3">
                                       <div class="radio-custom radio-info">
                                            <input type="radio" <?php echo e((old('member_type') == 3)?'checked':''); ?> value="2"   name="member_type" id="infor">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <?php echo e(Form::bsText('membership_card_no','Membership Card ',['class'=>'control-label'],'',['class'=>'form-control','placeholder'=>'Enter membership card no.'])); ?>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <?php echo e(Form::bsText('email','Email',['class'=>'control-label'],$user->email,['class'=>'form-control' ])); ?>
