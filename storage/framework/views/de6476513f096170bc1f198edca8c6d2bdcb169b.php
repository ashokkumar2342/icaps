    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="col-md-8">
                ...
                <div class="col-md-4">
                    <a class="btn btn-warning btn-sm" href="<?php echo e(route('seller.product.item.sale',[$product->ukey,$productItem->ukey])); ?>">Sale in this category</a>
    ...
    <br>
        <div class=" row">
            <div class="panel panel-default col-md-12 ">
                ...
                <?php echo Form::open(['route'=>['seller.product.item.sale.update',$product->ukey,$productItem->ukey,$saleOnProduct->ukey]]); ?>
                    ...
                    <div class="row">
                        <div class="form-group col-md-3">
                            ...
                            <?php echo Form::number('selling_price', $saleOnProduct->msp, ['class'=>'form-control','placeholder'=>'Selling price','required']); ?>
                         ...
                         <div class="form-group col-md-3">
                            ...
                            <?php echo Form::number('stock', $saleOnProduct->stock, ['class'=>'form-control']); ?>
