...
<div class="container">
	<div class="row ">
		<div class="col-md-9 sign-in-page">
			...
			<img src="<?php echo e(asset('assets/images/voterid.png')); ?>" height="150px;" alt="Voter Id card" title="Voter id card card" class="thumbnail" style="margin-left:10px;" align="right">
		...
		<div class="col-md-3  create-new-account">
				<?php echo $__env->make('front.information.quick_links', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
			</div>
	</div><!-- /.row -->
</div><!-- /.container -->
