    ...
    <div class="wrapper">
        <div id="createColor" class="collapse in row">
            <div class="panel col-md-6 col-md-offset-3 ">
                ...
                <?php echo Form::open(['route'=>['admin.color.update',$color->id]]); ?>

                     <div class="form-group">
                        <?php echo Form::label('name', 'Name', ['class'=>'control-label']); ?>

                        <?php echo Form::text('name', $color->name, ['class'=>'form-control']); ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group colorpicker-default colorpicker-component">
                            <input type="text"  value="<?php echo e((old('code'))?old('code'):$color->code); ?>" name="color" class="form-control">
