...
<head>
    ...
    <title><?php echo e(config('app.name', 'I-CAPS')); ?> :: User</title>
        ...
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?php echo e(route('front.home')); ?>">
                    <?php echo e(config('app.name', 'I-CAPS')); ?>: User 
                </a>
            </div>
            ...
            <div class="collapse navbar-collapse" id="app-navbar-collapse">
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <?php if(!Auth::guard('user')->check()): ?>
                        <li><a href="<?php echo e(route('user.login.form')); ?>">Login</a></li>
                        <li><a href="<?php echo e(route('user.register.form')); ?>">Register</a></li>
                    <?php else: ?>
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                <li>
                                    <a href="<?php echo e(route('user.logout.get')); ?>"
