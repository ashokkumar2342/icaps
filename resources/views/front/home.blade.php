		...
		<div class="col-xs-12 col-sm-12 col-md-9 homebanner-holder">
			...
			<div id="hero">
				<div id="owl-main" class="owl-carousel owl-inner-nav owl-ui-sm">
					...
					<div class="item">
						<img src="{{ asset('assets/images/sliders/04.jpg') }}">
					</div><!-- /.item -->
					<div class="item">
						<img src="{{ asset('assets/images/sliders/05.jpg') }}">
					</div><!-- /.item -->
					<div class="item">
						<img src="{{ asset('assets/images/sliders/06.jpg') }}">
					</div><!-- /.item -->
				</div><!-- /.owl-carousel -->
			</div>
...
<div id="product-tabs-slider" class="scroll-tabs outer-top-vs wow fadeInUp">
	<div class="more-info-tab clearfix ">
	   <h3 class="new-product-title pull-left">Membership Open</h3>
	</div>
						...
						<div class="products">
							<div class="product">		
								<div class="product-image">
									<div class="image">
										<a href="#"><img  src="assets/images/coupon/appolo.jpg" alt=""></a>
									</div><!-- /.image -->		   
								</div><!-- /.product-image -->
					...
					<div class="item item-carousel">
						<div class="products">
							<div class="product">		
								<div class="product-image">
									<div class="image">
										<a href="#"><img  src="assets/images/coupon/archies.jpg" alt=""></a>
									</div><!-- /.image -->		   
								</div><!-- /.product-image -->
							</div><!-- /.product -->
						</div><!-- /.products -->
					...
					<div class="item item-carousel">
						<div class="products">
							<div class="product">		
								<div class="product-image">
									<div class="image">
										<a href="#"><img  src="assets/images/coupon/bar.jpg" alt=""></a>
									</div><!-- /.image -->		   
								</div><!-- /.product-image -->
							</div><!-- /.product -->
						</div><!-- /.products -->
					...
					<div class="item item-carousel">
						<div class="products">
							<div class="product">		
								<div class="product-image">
									<div class="image">
										<a href="#"><img  src="assets/images/coupon/fitness2.jpg" alt=""></a>
									</div><!-- /.image -->		   
								</div><!-- /.product-image -->
							</div><!-- /.product -->
						</div><!-- /.products -->
					...
					<div class="item item-carousel">
						<div class="products">
							<div class="product">		
								<div class="product-image">
									<div class="image">
										<a href="#"><img  src="assets/images/coupon/fitnessss.jpg" alt=""></a>
									</div><!-- /.image -->		   
								</div><!-- /.product-image -->
							</div><!-- /.product -->
						</div><!-- /.products -->
					...
					<div class="item item-carousel">
						<div class="products">
							<div class="product">		
								<div class="product-image">
									<div class="image">
										<a href="#"><img  src="assets/images/coupon/SagarVilla.jpg" alt=""></a>
									</div><!-- /.image -->		   
								</div><!-- /.product-image -->
							</div><!-- /.product -->
						</div><!-- /.products -->
					...
					<div class="item item-carousel">
						<div class="products">
							<div class="product">		
								<div class="product-image">
									<div class="image">
										<a href="#"><img  src="assets/images/coupon/singar.jpg" alt=""></a>
									</div><!-- /.image -->		   
								</div><!-- /.product-image -->
							</div><!-- /.product -->
						</div><!-- /.products -->
					...
					<div class="item item-carousel">
						<div class="products">
							<div class="product">		
								<div class="product-image">
									<div class="image">
										<a href="#"><img  src="assets/images/coupon/studio.jpg" alt=""></a>
									</div><!-- /.image -->		   
								</div><!-- /.product-image -->
							</div><!-- /.product -->
						</div><!-- /.products -->
					...
					<div class="item item-carousel">
						<div class="products">
							<div class="product">		
								<div class="product-image">
									<div class="image">
										<a href="#"><img  src="assets/images/coupon/studio2.jpg" alt=""></a>
									</div><!-- /.image -->		   
								</div><!-- /.product-image -->
							</div><!-- /.product -->
						</div><!-- /.products -->
					...
					<div class="item item-carousel">
						<div class="products">
							<div class="product">		
								<div class="product-image">
									<div class="image">
										<a href="#"><img  src="assets/images/coupon/swastik.jpg" alt=""></a>
									</div><!-- /.image -->		   
								</div><!-- /.product-image -->
							</div><!-- /.product -->
						</div><!-- /.products -->
